...
export const INTERNAL_ROUTE_TRUST_CONTRACTS = {
  ...
  "cron/refresh-homepage-cache": cronSecretRoute("cron/internal automation"),
  ...
  "cron/refresh-graded-variant-prices": cronSecretRoute("cron/internal automation"),
  ...
  "cron/check-embedder-health": cronSecretRoute("cron/internal automation"),
