-- 20260303000500_fix_recalibrated_signal_price_column.sql
--
-- Follow-up fix for recalibrated signals: variant_price_latest stores
-- `latest_price`, not `price_value`.
...
begin
  ...
  signal_inputs as (
    select
      ...
      greatest(coalesce(vpl.latest_price, 0), 0.25)::numeric as price_anchor,
