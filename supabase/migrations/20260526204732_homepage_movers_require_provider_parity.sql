-- supersedes: 20260515183000_compute_daily_top_movers_warm_threshold_auto.sql
--
-- Require cross-provider price corroboration for homepage mover rails.
--
-- Background. The 2026-05-26 homepage audit found premium/vintage cards
-- whose Scrydex-only headline prices were far above TCGplayer market.
-- They were allowed into daily_top_movers because market_low_confidence
-- was false even though market_provenance.parityStatus was
-- MISSING_PROVIDER.
--
-- New behavior. daily_top_movers excludes cards whose current RAW market
-- price does not have an explicit cross-provider MATCH. This is
-- intentionally conservative: unknown, missing-provider, and mismatched
-- comparisons stay off the homepage so we show fewer market calls instead
-- of fresh-looking but uncorroborated prices.
--
-- Reversal: re-apply 20260515183000_compute_daily_top_movers_warm_threshold_auto.sql.
-- No data migration.
