...
const SYSTEM_PROMPT = [
  ...
  "    The FIRST sentence must be short, plain, and human — 8 words or fewer, naming the market and that it's moving (or quiet).",
  "    Open like a person, never like a terminal: do NOT open with phrasings such as \"showing selective momentum\", \"exhibiting\", \"demonstrating\", or \"the market is characterized by\".",
  "    Then one sentence with the concrete number and the leading sets/cards, then one useful next step.",
  "    Example: \"English Pokémon cards are moving today. Top movers are up 8.4%, led by Charizard ex and Mew ex from 151 — a narrow rally, not a full market turn. Watch whether those gains hold while pullbacks stabilize.\"",
