  ...
  const topViewedCards = rankedSlugs
    .map((slug) => {
      ...
      const result: HomepageCard = {
        ...
        market_price_display_state: market?.marketPriceDisplayState ?? null,
        recent_market_signal_usd: market?.recentMarketSignalUsd ?? null,
        recent_market_signal_as_of: market?.recentMarketSignalAsOf ?? null,
        recent_market_signal_delta_pct: market?.recentMarketSignalDeltaPct ?? null,
        recent_market_signal_direction: market?.recentMarketSignalDirection ?? null,
