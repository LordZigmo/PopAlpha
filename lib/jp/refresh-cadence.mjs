 ...
 *
 * yahoo_jp.hotSnkrdunkCovered: a hot card that also has a Snkrdunk price row
 * gets its daily series from Snkrdunk; Yahoo re-checks at 96h instead of
 * double-scraping the same card daily on both sources.
 *
