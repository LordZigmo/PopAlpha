 ...
 * found at least 4 real-world shapes:
 *
 ...
 *   "Hisuian Zoroark VSTAR UR[S10a 097/071](Enhanced Expansion Pack "Dark Phantasma")"
 *
 ...
 *   setCode:     "S-P" | "S10b" | "PMCG-P" | null,
 *   cardNumber:  "104" | "074/071" | "074/073" | "No.009",
...
export function parseSnkrdunkProductName(name) {
  ...
  const setCode = bracketSplit ? bracketSplit[1] : null;
  const cardNumber = bracketSplit ? bracketSplit[2] : bracketContent;
