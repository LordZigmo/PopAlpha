...
- **Still outstanding:** signed TestFlight archive from current `main` HEAD → App Store Connect. On-device, confirm the price parity (Claydol/Cobalion detail == homepage) and a populated Market Watch tab.
