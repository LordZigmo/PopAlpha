...
const TIERS: TierConfig[] = [
  {
    ...
    price: "$0",
    cadence: "/month",
    blurb: "Start seeing your collection clearly. Free to use, with the basics to track what you own and what's moving.",
    bullets: [
      "Browse cards, sets, and price moves",
      "Use the free PopAlpha Scout",
  ...
  },
  {
    ...
    price: "$12.99",
    cadence: "/month",
    blurb: "Sharper reads on what's moving and why. Built for collectors who check the market more than once a day.",
    bullets: [
      "Smarter AI analysis on every card",
      "Deeper tools for active collectors",
      "Faster way to spot what's worth a look",
    ],
  ...
  },
  {
    ...
    price: "$19.99",
    cadence: "/month",
    blurb: "See the market the way serious collectors do. Every premium signal, with no rails locked off.",
    bullets: [
      "Every premium signal, fully unlocked",
      "Whale Radar and top-tier rails",
      "The full toolkit for serious tracking",
    ],
    ctaLabel: "Join The Waitlist",
    featured: true,
  },
