    ...
    <>
      ...
      <MarketSummaryCardClient
        variants={variants.map((variant) => ({
          ...
          recentMarketSignalUsd: variant.recentMarketSignalUsd,
          recentMarketSignalAsOf: variant.recentMarketSignalAsOf,
          recentMarketSignalDeltaPct: variant.recentMarketSignalDeltaPct,
          recentMarketSignalDirection: variant.recentMarketSignalDirection,
