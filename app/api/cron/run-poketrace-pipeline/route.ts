...
import { runPokeTracePipeline } from "@/lib/backfill/provider-pipeline-orchestrator";
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const defaults = getQueuedBatchPreset("POKETRACE", "PIPELINE");
    const params = {
    ...
    const result = await runPokeTracePipeline({
